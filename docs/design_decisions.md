...
[161](#161-le-cap--une-base-de-données-déterministe-et-sûre-le-reste-chez-le-fournisseur-de-lusager) Le cap : une base de données déterministe et sûre, le reste chez le fournisseur de l'usager ·
...
## 161. Le cap : une base de données déterministe et sûre, le reste chez le fournisseur de l'usager
